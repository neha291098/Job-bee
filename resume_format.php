				    ...
				    <div class="container-fluid">
				        ...
				        <div id="navbar" class="navbar-collapse collapse">
				            <ul class="nav navbar-nav navbar-right">
								...
								<button type="button" id="myBtn" name="submit" class="btn btn-primary" onclick="window.location.href = 'http://localhost/logging_out.php'">Log out</button></li>
...
<section>
<div  style="background-image: url(images/pmid.jpg)" class="left-sec profile_info">ggkjbklnkln<br><br><BR>cjkbbf</div>
