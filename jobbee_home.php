		...
		<header class="header site-header">
			<div class="container">
				...
				if (empty($_SESSION['logged_in_user']) & empty($_SESSION['logged_in_com']))
					...
					?>			
					<!--<li class="dropdown yamm-fw hasmenu">
				        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Sign up <span class="fa fa-angle-down"></span></a>
							<ul class="dropdown-menu">
						                <li>
										<div class="yamm-content">
										<ul>
							                    			<li><a href="service-01.html">Company</a></li>
							                    			<li><a href="service-02.html">Applicant</a></li>
										</ul>
										</div>
										</li>
										</ul>
...
<?php if(!empty($_SESSION['message_login'])) { 
   $msg=$_SESSION['message_login'];
	...
	?>
		...
		<section class="section transheader homepage parallax" data-stellar-background-ratio="0.5" style="background-image:url('upload/landscape_img.jpg');">
			<div class="container">
				<div class="row">	
						        ...
						        <div class="item-top form-inline">
						            <div class="form-group">
						                <div class="input-group2">
						                    ...
						                    <input type="url" class="form-control" id="urladres" name="url" placeholder="Job Profile">
						                </div>
						            </div>
				...
				<div class="row text-center">
					...
					<div class="col-md-3 col-sm-6 nopad last">
						<div class="home-service c4">
							...
							<p>Review and get to know about companies</p>
						</div><!-- end home-service -->
					</div><!-- end col -->
				</div><!-- end row -->
			</div><!-- end container -->
		...
		<section class="section overfree">
			...
			<div class="container">
				...
				<div class="row callout bgcolor">
					<div class="col-md-9">
						<p class="lead">Subscribe to recieve updates on latest job openings.</p>
					</div>
					<div class="col-md-3">
						<div class="button-wrap text-center">
							<a href="#" class="btn btn-transparent btn-light btn-lg">Subscribe</a>
						</div>
					</div>
				</div>
			</div>
