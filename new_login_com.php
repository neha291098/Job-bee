...
<body>
   ...
   $msg=$_SESSION['c_message'];
	...
	?>
				<form action="job_suggestion_website/com_login_action.php" method="post" role="form" class="contactform">
				<!--<div class="next_box" >-->
	...
	<fieldset>
      ...
      <input type="text" class="form-control" id="c_Name" placeholder="Enter Name" name="C_Ename" required>
    </div>
	<div class="form-group">
      <label for="Address">Company</label>
      <input type="text" class="form-control" id="c_Company" placeholder="Enter Address" name="C_Company">
    </div>
	<div class="form-group">
      <label for="Address">Job Title</label>
      <input type="text" class="form-control" id="c_JobTitle" placeholder="Enter Address" name="C_JobTitle">
    </div>
   ...
   $msg=$_SESSION['c_message'];
	...
	<div class="form-group">
      ...
      <input type="password" class="form-control" id="C_Setpwd" placeholder="Enter Password" name="C_Setpwd" onkeyup='check();'>
    </div>
	<div class="form-group">
      <label for="Skills">Confirm Password</label>
      <input type="password" class="form-control" id="C_rPwd" placeholder="Enter Password" name="C_rPwd" onkeyup='check();'>
