...
<body>
   ...
   $msg=$_SESSION['message'];
	...
	?>
				<form action="job_suggestion_website/user_login_action.php" method="post" role="form" class="contactform">
				<!--<div class="next_box" >-->
				<fieldset>
      ...
      <textarea rows="" class="form-control" id="Objective" placeholder="Enter Objective" name="Objective"></textarea>
    </div>
	</div>
	</fieldset>
	<fieldset>
   ...
   $msg=$_SESSION['message'];
	...
	?>
      ...
      <input type="number" class="form-control" id="ph_no" placeholder="Enter Phone Number" name="Ph_no">
	...
	<legend class="lead"><center><b>High School</b></center></legend>
      ...
      <input type="number" class="form-control" id="tenth_per" placeholder="Enter percentage" name="Tenth_per">
    </div>
	    <div class="form-group">
      <label for="tenth_school">School</label>
      <input type="text" class="form-control" id="tenth_school" placeholder="Enter School" name="Tenth_school">
    </div>
	    <div class="form-group">
      <label for="tenth_Board">Board</label>
      <input type="text" class="form-control" id="tenth_Board" placeholder="Enter Board" name="Tenth_board">
    </div>
	</fieldset>
	<fieldset>
	<legend class="lead"><center><b>Intermediate</b></center></legend>
      ...
      <input type="text" class="form-control" id="twelth_school" placeholder="Enter School" name="Twelth_school">
    </div>
	    <div class="form-group">
      <label for="twelth_Board">Board</label>
      <input type="text" class="form-control" id="twelth_Board" placeholder="Enter Board" name="Twelth_board">
    </div>
	</fieldset>
